<template>
    ...
    <div class="card m-3">
        ...
        <DataTable v-model:selection="selectedItem" selectionMode="single" :value="items" stripedRows showGridlines
            editMode="cell" @cell-edit-complete="updateItem" @cell-edit-init="beginEdit" @keyup.ctrl.delete.exact="deleteItem">
            <template #header>
                ...
                <div @keyup.ctrl.enter="submitItem" @keyup.enter.exact="getProduct('new')" class="card p-3"
                    ...
                    <div class="formgrid grid">
                        ...
                        <div class="field col-1">
                            ...
                            <InputNumber v-model="newItem.discount" class="w-full" id="discount" inputId="percent" prefix="%" :min="0" :max="100" />
                        </div>
                        <div class="field col-1">
