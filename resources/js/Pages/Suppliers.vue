            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <Toolbar class="mb-4">
                        <template v-slot:end>
                            <div class="my-2">
                                <Button v-if="can('add supplier')" label="New" icon="pi pi-plus"
                                        class="p-button-success mr-2" @click="newSupplierDialog = true"/>
                                <Button label="Delete" icon="pi pi-trash" class="p-button-danger"
                                        v-if="can('delete supplier') && selectedSuppliers.length > 0"
                    ...
                    <DataTable v-model:selection="selectedSuppliers" v-model:editingRows="editingRows"
                        ...
                        <Column v-if="can('delete supplier')" selectionMode="multiple"
                        ...
                        <Column v-if="can('edit supplier')" :rowEditor="true" style="width: 10%; min-width: 8rem"
                                bodyStyle="text-align:center">
                        </Column>
                    </DataTable>

                    <Dialog v-model:visible="newSupplierDialog" header="Supplier Information"
                            :style="{ width: '450px' }"
                            class="p-fluid">
                        <div class="field">
